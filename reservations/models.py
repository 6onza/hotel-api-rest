...
class Reservation(models.Model):
    ...
    credit_card_exp_month = models.CharField(max_length=2, blank=True, null=True)
    credit_card_exp_year = models.CharField(max_length=4, blank=True, null=True)
    credit_card_cvc = models.CharField(max_length=3, blank=True, null=True)
